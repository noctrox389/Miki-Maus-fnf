...
local xx = 1150; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local yy3 = 600; -- Same code as above, but for girlfriend, up, down
